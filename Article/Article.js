...
function createArticle(title, date, oneParagraph, twoParagraph, threeParagraph){
  ...
  pOne.textContent = oneParagraph;
  pTwo.textContent = twoParagraph;
  pThree.textContent = threeParagraph;
